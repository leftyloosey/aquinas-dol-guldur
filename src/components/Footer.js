function Footer () {
    return (
        ...
        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
          <li className="ms-3"><a className="text-muted" href="https://github.com/leftyloosey"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="7" fill="currentColor" classn="bi bi-github" viewBox="0 0 16 16">
